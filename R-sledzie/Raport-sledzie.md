...
Surowe dane zawierają 52582 próbek (wierszy) oraz 16 atrybutów (kolumn).
...
Dane po przetworzeniu i uzupełnieniu brakujących wartości zawierają 52581 próbek (wierszy) oraz 16 atrybutów (kolumn).
...
## 
##   mtry  RMSE      Rsquared 
##    2    1.139389  0.5244018
##    8    1.102547  0.5557599
##   15    1.194154  0.5023622
## 
...
![](Raport-sledzie_files/figure-html/plot_prediction_vs_testing-1.png)<!-- -->![](Raport-sledzie_files/figure-html/plot_prediction_vs_testing-2.png)<!-- -->
